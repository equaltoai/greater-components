      ...
      >
        ...
        {#snippet action()}
          <div class="search-actions">
            ...
            <button class="action-button action-button--secondary" onclick={() => window.location.href = '/explore'}>
              Explore Trending
            </button>
          </div>
        {/snippet}
        ...
        <div class="custom-empty-state" class:animated={showAnimation}>
          <div class="illustration">
            <svg viewBox="0 0 200 200" width="200" height="200">
              ...
              <path
                d="M 100 60 L 120 90 L 100 80 L 80 90 Z"
                fill="#0ea5e9"
                class="float"
              />
            </svg>
          ...
          <div class="content">
            ...
            <p class="description">
              Start your journey by following interesting people and communities.
