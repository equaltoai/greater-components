	...
	{#if filterHistory.length > 0}
		<div class="filter-history">
			<div class="filter-history-header">
				...
				<button class="clear-history-btn" onclick={clearFilterHistory}> Clear </button>
			</div>
...
<div class="url-filtered-search">
	...
	<div class="filter-info">
		...
		<p class="share-hint">You can share this filtered view using the Share button above</p>
	</div>
...
<div class="analytics-filters">
	<div class="analytics-panel">
		<div class="analytics-header">
			...
			<button class="reset-stats-btn" onclick={resetStats}> Reset </button>
		</div>
...
<div class="custom-filters-design">
	<div class="filter-showcase">
		...
		<p class="filter-description">Select a filter to refine your search results</p>
	</div>
...
describe('Search.Filters', () => {
	...
	it('updates active filter on click', async () => {
		...
		expect(onSearch).toHaveBeenCalledWith(expect.objectContaining({ type: 'actors' }));
	});
