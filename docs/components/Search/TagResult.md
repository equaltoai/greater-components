...
<div class="trending-tag-search">
  ...
  <p class="description">
    Discover trending topics with historical data and growth indicators
  </p>
  ...
  <Search.Root {handlers}>
    ...
    <div class="enhanced-tag-results">
      {#snippet tagResult(tag: EnhancedSearchTag)}
        <article 
          class="enhanced-tag-result"
          class:trending={tag.trending}
        >
          ...
          >
            <div class="category-header">
              ...
              <div class="category-meta">
                ...
                <button 
                  class="follow-category-btn"
                  onclick={() => followCategory(category)}
                >
                  Follow All
                </button>
              </div>
...
<div class="managed-tag-search">
  <div class="search-header">
    ...
    <div class="tag-stats">
      ...
      <button class="export-btn" onclick={exportTagLists}>
        Export Lists
      </button>
    </div>
  </div>
...
<div class="discovery-tag-search">
  ...
  <p class="description">
    Search tags and explore related topics to discover new content
  </p>
...
<button 
  role="button"
  aria-label="Search for #javascript tag"
>
  #javascript
</button>
```
