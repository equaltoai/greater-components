...
<div class="full-composer">
	...
	>
		<Compose.Editor autofocus placeholder="What's on your mind?" rows={4} />
		...
		<div class="draft-prompt">
			<div class="draft-prompt-content">
				...
				<div class="draft-prompt-actions">
					<button onclick={loadDraft} class="btn-primary"> Load Draft </button>
					<button onclick={discardDraft} class="btn-secondary"> Discard </button>
				</div>
			</div>
		</div>
	{/if}
