...
<div class="loading-composer">
	<Compose.Root handlers={{ onSubmit: handleSubmit }}>
		<div class="editor-wrapper" class:submitting={isSubmitting}>
			<Compose.Editor autofocus rows={4} class="styled-editor" />
...
<div class="validated-composer">
	...
	<Compose.Root handlers={{ onSubmit: handleSubmit }}>
		<Compose.Editor autofocus rows={5} oninput={handleInput} />

		<div class="help-text">Minimum 10 characters. No spam or scam content. Max 3 links.</div>
...
```svelte
<Compose.EditorWithAutocomplete {searchHandler} />
```
