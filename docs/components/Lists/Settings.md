		...
		onUpdate: async (id: string, data) => {
			...
			if (!response.ok) {
				...
				if (error.code === 'PUBLIC_LIST_LIMIT_REACHED') {
					throw new Error(
						`You have reached the maximum of ${userPermissions.maxPublicLists} public lists`
					);
					...
					{:else if publicListCount >= userPermissions.maxPublicLists && context.state.selectedList.visibility === 'private'}
						<div class="permission-notice notice--info">
							...
							<div>
								...
								<p>
									You have {publicListCount} of {userPermissions.maxPublicLists} public lists. To make
									this list public, please make another list private first.
								</p>
							</div>
						</div>
					{/if}
			...
			<div class="settings-with-autosave">
				...
				<div class="save-status">
					...
					{:else if saveStatus === 'error'}
						<span class="status status--error"> ✗ Save failed </span>
					{/if}
				</div>
							...
							<div class="danger-content">
								...
								<div class="danger-action">
									<div class="danger-action-info">
										...
										<p>
											Permanently delete this list and remove all members. This action cannot be
											undone.
										</p>
									</div>
