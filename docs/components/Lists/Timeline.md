	...
	<div class="lists-layout">
		...
		<main>
			<Lists.Timeline showMembers={true}>
				{#if listId}
					<Timeline.Root bind:this={timelineComponent} filters={{ listId }} />
				{/if}
			</Lists.Timeline>
		</main>
	</div>
		...
		<main>
			<Lists.Timeline showMembers={true}>
				<div class="posts-container">
					...
					{:else if timelinePosts.length > 0}
						<div class="end-message">You've reached the end of the timeline</div>
					{/if}
				</div>
			</Lists.Timeline>
		</main>
			...
			<div class="filter-bar">
				...
				<div class="filter-options">
					<label class="filter-option">
						<input type="checkbox" bind:checked={filterOptions.mediaOnly} />
						<span>Media only</span>
					</label>

					<label class="filter-option">
						<input type="checkbox" bind:checked={filterOptions.excludeReplies} />
						<span>Exclude replies</span>
					</label>

					<label class="filter-option">
						<input type="checkbox" bind:checked={filterOptions.excludeReblogs} />
