    ...
    <div class="picker-panel">
      ...
      <div class="search-filters">
        <label class="filter-checkbox">
          <input
            type="checkbox"
            bind:checked={searchFilters.includeFollowing}
          />
        ...
        <label class="filter-checkbox">
          <input
            type="checkbox"
            bind:checked={searchFilters.includeFollowers}
          />
        ...
        <label class="filter-checkbox">
          <input
            type="checkbox"
            bind:checked={searchFilters.localOnly}
          />
            ...
            {#each context.state.members as member (member.id)}
              <div class="member-item">
                ...
                {#if member.actor.avatar}
                  <img src={member.actor.avatar} alt={member.actor.displayName} class="member-avatar" />
                {:else}
    ...
    try {
      ...
      for (const username of usernames) {
        try {
          ...
          errors.push(`Failed to add ${username}: ${error instanceof Error ? error.message : 'Unknown error'}`);
          failed++;
        }
      }
                ...
                <div class="member-avatar-container">
                  ...
                  {#if activity}
                    <span
                      ...
                      title={activity.online ? 'Online' : activity.lastSeen ? `Last seen ${formatLastSeen(activity.lastSeen)}` : 'Offline'}
                    ></span>
                  {/if}
                </div>
...
<input
  type="text"
  aria-label="Search accounts to add to list"
