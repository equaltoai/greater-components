...
<script lang="ts">
	...
	type ExtendedAccount = GenericStatus['account'] & {
		verified?: boolean;
		supporter?: boolean;
			...
			<div class="custom-account-info">
				<div class="account-name-row">
					...
					{#if account.role === 'admin'}
						<span class="badge badge--role badge--admin" title="Administrator"> ADMIN </span>
					{:else if account.role === 'moderator'}
						<span class="badge badge--role badge--moderator" title="Moderator"> MOD </span>
					{/if}
		...
		{#snippet timestamp()}
			<div class="custom-timestamp">
				...
				{#if status.edited && status.editedAt}
					<button class="edited-indicator" onclick={loadEditHistory} title="View edit history">
...
<div class="status-header">
	...
	<div class="status-header__main">
		...
		<a href="/profile" aria-label="View Alice's profile">
