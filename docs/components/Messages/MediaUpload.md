...
<MediaUpload onUpload={handleUpload} class="custom-uploader" />
...
<div class="paste-uploader">
	...
	<MediaUpload onUpload={handleUpload} accept="image/*" maxFiles={10} showPreviews={true} />
...
```svelte
<div class="upload-area" role="button" tabindex="0" aria-label="Click or drag files to upload">
	<input type="file" aria-label="File upload input" accept="image/*,video/*" />
</div>
```
