...
<Messages.Root {handlers} autoFetch={true}>
	<div class="infinite-scroll-thread">
		...
		<div class="thread-with-history" bind:this={threadContainer} onscroll={handleScroll}>
			{#if isLoadingHistory}
...
<Messages.Root {handlers} autoFetch={true}>
	<div class="realtime-thread">
		...
		<div class="thread-container" bind:this={threadContainer} onscroll={checkScrollPosition}>
			<Messages.Thread />
...
```svelte
<div role="log" aria-label="Message thread" aria-live="polite" aria-relevant="additions">
	<Messages.Thread />
</div>
```
				...
				onFetchMessages: async () => [
					{
						id: '1',
						content: 'Hello',
						sender: { id: '1', username: 'user1', displayName: 'User' },
