...
<script lang="ts">
	...
	const isOwnProfile = $derived($profileQuery.data?.id === currentUserId);
...
{:else if $profileQuery.data}
	<div class="profile-page">
		<Profile.Root profile={$profileQuery.data} {handlers} {isOwnProfile}>
			...
			<div class="profile-content">
				...
				<aside class="profile-sidebar">
					{#if isOwnProfile}
						<Profile.FollowRequests requests={followRequests} showBatchActions={true} />
					{/if}

					<Profile.EndorsedAccounts endorsed={endorsedAccounts} {isOwnProfile} maxAccounts={3} />
