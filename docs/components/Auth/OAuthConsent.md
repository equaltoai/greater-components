...
<Auth.Root>
  {#if existingAuthorizations.length > 0}
    <div class="revoke-notice">
      ...
      <p>
        You have {existingAuthorizations.length} existing authorization{existingAuthorizations.length > 1 ? 's' : ''} 
  ...
  {#if showRevokeConfirmation}
    <div class="modal">
      <div class="modal-content">
        ...
        <p>
          This will revoke all existing authorizations for this application.
          The app will stop working until you authorize it again.
        </p>
        <div class="modal-actions">
          <button onclick={revokeExisting} class="btn-danger">
            Revoke All
          </button>
          <button onclick={() => showRevokeConfirmation = false}>
            Cancel
          </button>
        </div>
      </div>
