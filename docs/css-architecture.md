...
import '@equaltoai/greater-components/tokens/theme.css';      // 1. Base tokens first
import '@equaltoai/greater-components/tokens/themes/dark.css'; // 2. Theme overrides (optional)
import '@equaltoai/greater-components/primitives/style.css';  // 3. Component styles last
```

```svelte
// ❌ INCORRECT: Component styles before tokens
import '@equaltoai/greater-components/primitives/style.css';  // Wrong - uses undefined variables
import '@equaltoai/greater-components/tokens/theme.css';      // Too late - variables needed above
```
