...
The repo now includes a blessed FaceTheory host example at [`examples/facetheory-svelte`](../examples/facetheory-svelte). It is currently validated against FaceTheory `v3.1.2`, the current Theory Cloud platform release pinned by this workspace. It wires:
