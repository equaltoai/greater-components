...
The repo now includes a blessed FaceTheory host example at [`examples/facetheory-svelte`](../examples/facetheory-svelte). It is currently validated against FaceTheory `v4.0.5`, the current Theory Cloud platform release pinned by this workspace. It wires:
