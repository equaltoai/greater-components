...
greater add faces/social`});var g=r(h,4);l(g,{language:`bash`,code:`pnpm add @equaltoai/greater-components`}),o(m);var _=r(m,2),v=r(a(_),4),y=a(v),b=r(a(y),2);l(b,{language:`bash`,code:`npm install @equaltoai/greater-components-primitives`}),i(2),o(y);var x=r(y,2),S=r(a(x),2);l(S,{language:`bash`,code:`npm install @equaltoai/greater-components-tokens`}),i(2),o(x);var C=r(x,2),w=r(a(C),2);l(w,{language:`bash`,code:`npm install @equaltoai/greater-components-icons`}),i(2),o(C);var T=r(C,2),E=r(a(T),2);l(E,{language:`bash`,code:`npm install @equaltoai/greater-components-content`}),i(2),o(T);var D=r(T,2),O=r(a(D),2);l(O,{language:`bash`,code:`npm install @equaltoai/greater-components-utils`}),i(2),o(D),o(v),o(_);var k=r(_,2),A=r(a(k),6);l(A,{language:`svelte`,title:`+layout.svelte`,code:`<script lang="ts">
...
<ThemeProvider>
  {@render children()}
</ThemeProvider>`});var j=r(A,6);l(j,{language:`svelte`,title:`MyComponent.svelte`,code:`<script>
...
<Modal bind:open={showModal} title="Welcome!">
  ...
  {/snippet}
</Modal>`}),o(k);var M=r(k,2),N=r(a(M),8);l(N,{language:`json`,title:`tsconfig.json`,code:`{
  "compilerOptions": {
...
}`});var P=r(N,6);l(P,{language:`typescript`,code:`import { Button, type ButtonProps } from '@equaltoai/greater-components/primitives';
import type { ThemeConfig } from '@equaltoai/greater-components/tokens';`}),o(M);var F=r(M,2),I=r(a(F),4),L=a(I);u(L,{size:20}),i(2),o(I),o(F);var R=r(F,2),z=r(a(R),8);l(z,{language:`javascript`,title:`vite.config.js`,code:`export default {
  optimizeDeps: {
    include: [
...
}`}),o(R),i(2),o(p),n(e,p)}export{p as component};