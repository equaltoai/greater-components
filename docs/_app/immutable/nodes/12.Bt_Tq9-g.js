...
{/snippet}`}),d(A);var M=s(A,2),N=s(u(M),2);_(N,c(()=>E)),d(M);var P=s(M,2),F=s(u(P),2);a(F,7,()=>D,(e,t)=>`${t}-${e}`,(e,t)=>{var r=x(),a=u(r,!0);d(r),n(()=>p(a,i(t))),o(e,r)}),d(F),d(P);var I=s(P,2),L=s(u(I),2);a(L,5,()=>O,e=>e.label,(e,t)=>{var r=S(),a=u(r),c=u(a,!0);d(a);var l=s(a);d(r),n(()=>{p(c,i(t).label),p(l,` — ${i(t).detail??``}`)}),o(e,r)}),d(L),d(I),o(e,f)},$$slots:{default:!0}})}export{w as component};