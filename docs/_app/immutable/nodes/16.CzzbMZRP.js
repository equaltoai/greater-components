import"../chunks/DsnmJJEf.js";import"../chunks/ttMDPgN5.js";import{f as n,a,e as l,s as o,c as i,$ as d,r as s}from"../chunks/CAqKBpMZ.js";import{h as b}from"../chunks/BGh-p3ai.js";import{C as h}from"../chunks/BVft0-qW.js";var u=n('<meta name="description" content="Accessibility best practices and built-in WCAG support in Greater Components."/>'),g=n(`<article class="guide-page"><header><p class="eyebrow">Guide</p> <h1>Accessibility</h1> <p class="lead">Greater Components is designed to be accessible by default. Components ship with keyboard
			...
			labels.</p></section> <section><h2>Testing with axe</h2> <p>Use the testing helpers package to run accessibility checks in component tests.</p> <!></section></article>`);function C(r){var e=g();b("1d8i4ob",p=>{var m=u();l(()=>{d.title="Accessibility Guide - Greater Components"}),a(p,m)});var t=o(i(e),4),c=o(i(t),4);h(c,{language:"typescript",code:`import { test, expect } from 'vitest';
...
});`}),s(t),s(e),a(r,e)}export{C as component};
