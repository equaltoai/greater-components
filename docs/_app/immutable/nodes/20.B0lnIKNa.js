...
</ThemeProvider>`,language:`svelte`}),i(2),o(p);var h=r(p,2),g=r(a(h),4);l(g,{code:`<script>
...
<ThemeProvider {theme}>
  <YourApp />
</ThemeProvider>`,language:`svelte`});var _=r(g,6);l(_,{code:`<script>
...
<p>Current theme: {theme}</p>`,language:`svelte`}),o(h);var v=r(h,2),y=r(a(v),4);l(y,{code:`/* Light mode (default) */
:root {
...
}`,language:`css`});var b=r(y,6);l(b,{code:`@media (prefers-color-scheme: dark) {
  :root {
    --gr-semantic-background-primary: #0f172a;
    --gr-semantic-foreground-primary: #f8fafc;
    /* ... other dark mode overrides */
  }
}`,language:`css`}),o(v);var x=r(v,2),S=r(a(x),4);l(S,{code:`/* Add to your global styles */
:root {
...
}`,language:`css`}),o(x);var C=r(x,2),w=r(a(C),4);l(w,{code:`<!-- In your app.html -->
<head>
  <script>
    (function() {
  ...
  <\/script>
</head>`,language:`html`}),o(C);var T=r(C,2),E=r(a(T),8);l(E,{code:`/* Light mode: darker shadows for depth */
.card {
...
}`,language:`css`});var D=r(E,6);l(D,{code:`/* Reduce image brightness in dark mode */
[data-theme="dark"] img {
...
</picture>`,language:`html`}),o(T);var O=r(T,4),k=r(a(O),4);l(k,{code:`// In your tests
...
});`,language:`typescript`}),o(O),i(2),o(f),n(e,f)}export{f as component};