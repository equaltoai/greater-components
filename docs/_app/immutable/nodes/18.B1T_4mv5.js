import{D as e,G as t,T as n,Y as r,lt as i,q as a,ut as o,v as s,z as c}from"../chunks/Fh0I5CkL.js";import"../chunks/xihTtKlq.js";import"../chunks/ClL9uNOJ.js";import{t as l}from"../chunks/D00RY0FZ.js";var u=e(`<meta name="description" content="Strict CSP compatibility for Greater Components: no inline styles/scripts, CSP-safe customization patterns, and a compatibility matrix."/>`),d=e(`<article class="guide-page svelte-rl24im"><header><p class="eyebrow svelte-rl24im">Guide</p> <h1 class="svelte-rl24im">CSP Compatibility</h1> <p class="lead svelte-rl24im">Lesser deployments run with a strict Content Security Policy (CSP). This guide explains what’s
			...
			breaking changes.</p></section></article>`);function f(e){var f=d();s(`rl24im`,e=>{var r=u();c(()=>{t.title=`CSP Compatibility - Greater Components`}),n(e,r)});var p=r(a(f),4),m=r(a(p),6);l(m,{title:`CSP-safe styling: class + external CSS`,language:`svelte`,code:`<!-- ✅ CSP-safe: use class -->
...
</style>`}),o(p);var h=r(p,4),g=r(a(h),4);l(g,{language:`svelte`,code:`<!-- Presets -->
...
</style>`});var _=r(g,4);l(_,{language:`svelte`,code:`<!-- Supported clamp range (2–6) -->
...
</style>`});var v=r(_,4);l(v,{language:`svelte`,code:`<!-- Presets -->
...
</style>`}),o(h);var y=r(h,2),b=r(a(y),4);l(b,{language:`bash`,code:`pnpm validate:csp`}),i(2),o(y),i(2),o(f),n(e,f)}export{f as component};