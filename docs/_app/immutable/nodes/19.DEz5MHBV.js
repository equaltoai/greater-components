import{D as e,G as t,T as n,Y as r,lt as i,q as a,ut as o,v as s,z as c}from"../chunks/Fh0I5CkL.js";import"../chunks/xihTtKlq.js";import"../chunks/ClL9uNOJ.js";import{t as l}from"../chunks/D00RY0FZ.js";var u=e(`<meta name="description" content="Migration guide for strict CSP compatibility: Skeleton sizing, Text clamping, Container gutters, and Avatar placeholder colors."/>`),d=e(`<article class="guide-page svelte-nw4cuu"><header><p class="eyebrow svelte-nw4cuu">Guide</p> <h1 class="svelte-nw4cuu">CSP Migration Guide</h1> <p class="lead svelte-nw4cuu">If you’re upgrading from older Greater Components versions that allowed per-instance styling,
...
<Skeleton width={customWidth} height={customHeight} />`});var h=r(m,2);l(h,{title:`After`,language:`svelte`,code:`<!-- ✅ After: presets -->
...
</style>`}),o(p);var g=r(p,2),_=r(a(g),4);l(_,{title:`Before`,language:`svelte`,code:`<!-- ❌ Before: per-instance line clamps via inline CSS -->
<Text truncate lines={10}>…</Text>
<Text truncate lines={dynamicLines}>…</Text>`});var v=r(_,2);l(v,{title:`After`,language:`svelte`,code:`<!-- ✅ After: presets (2–6) -->
...
</style>`}),o(g);var y=r(g,2),b=r(a(y),4);l(b,{title:`Before`,language:`svelte`,code:`<!-- ❌ Before: custom gutter values -->
<Container gutter="2.5rem">…</Container>
<Container gutter={customGutter}>…</Container>`});var x=r(b,2);l(x,{title:`After`,language:`svelte`,code:`<!-- ✅ After: presets -->
...
</style>`}),o(y);var S=r(y,2),C=r(a(S),4);l(C,{language:`svelte`,code:`<!-- ✅ No API change required -->
<Avatar name="Jane Doe" />

<!-- Placeholder color is now deterministic -->
<!-- e.g., gr-avatar--color-0 ... gr-avatar--color-11 -->`}),o(S);var w=r(S,2),T=r(a(w),4);l(T,{language:`svelte`,code:`<!-- ✅ Use class-based overrides -->
...
</style>`}),o(w),i(2),o(f),n(e,f)}export{f as component};