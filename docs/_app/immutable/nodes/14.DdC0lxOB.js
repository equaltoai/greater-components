...
</ThemeProvider>`}),u(k);var j=s(k,2),M=s(l(j),2);g(M,c(()=>T)),u(j);var N=s(j,2),P=s(l(N),2);a(P,7,()=>E,(e,t)=>`${t}-${e}`,(e,t)=>{var r=b(),a=l(r,!0);u(r),n(()=>f(a,i(t))),o(e,r)}),u(P),u(N);var F=s(N,2),I=s(l(F),2);a(I,5,()=>D,e=>e.label,(e,t)=>{var r=x(),a=l(r),c=l(a,!0);u(a);var d=s(a);u(r),n(()=>{f(c,i(t).label),f(d,` — ${i(t).detail??``}`)}),o(e,r)}),u(I),u(F),o(e,d)},$$slots:{default:!0}})}export{C as component};