...
<ThemeProvider theme="dark">
  <YourApp />
</ThemeProvider>`,language:`svelte`}),i(4),o(p);var h=r(p,2),g=r(a(h),4);l(g,{code:`<!-- Palette presets are class-based for strict CSP compatibility -->
<ThemeProvider palette="slate">
  <YourApp />
</ThemeProvider>

<!-- Available presets: slate, stone, neutral, zinc, gray -->`,language:`svelte`}),o(h);var _=r(h,2),v=r(a(_),4);l(v,{code:`<ThemeProvider class="brand-theme">
  <YourApp />
</ThemeProvider>
...
<style>
...
</style>`,language:`svelte`}),o(_);var y=r(_,2),b=r(a(y),4);l(b,{code:`:root {
  ...
  --gr-radii-lg: 12px;
}`,language:`css`});var x=r(b,6);l(x,{code:`:root {
  /* Background colors */
...
[data-theme="dark"] {
  ...
  /* ... dark mode overrides */
}`,language:`css`}),o(y);var S=r(y,2),C=r(a(S),4);l(C,{code:`<script>
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
...
<ThemeWorkbench 
  initialColor="#3b82f6" 
  onSave={handleSave} 
/>`,language:`svelte`}),i(6),o(S);var w=r(S,2),T=r(a(w),4);l(T,{code:`import { 
  generateTheme, 
...
// Returns: true`,language:`typescript`}),o(w);var E=r(w,2),D=r(a(E),4);l(D,{code:`<!-- Using CSS class -->
...
`,language:`svelte`}),o(E),i(4),o(f),n(e,f)}export{f as component};