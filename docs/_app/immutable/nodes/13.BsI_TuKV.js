...
</Modal>`}),s(v);var d=e(v,2),S=e(t(d),8);o(S,{language:"json",title:"tsconfig.json",code:`{
  "compilerOptions": {
...
}`});var z=e(S,6);o(z,{language:"typescript",code:`import { Button, type ButtonProps } from '@equaltoai/greater-components-primitives';
