...
- **Audit surfaces upstream-coordination need** (pre-release Lesser / Lesser Host coordination) — pause; coordinate via the upstream steward through the principal before proceeding.
