...
If the framework blocks critical work, escalate to the principal. Forking / patching is scope-level, not steward-level.
...
- **"Framework isn't responsive; let's fork."** Escalate to the principal; forking is scope-level.
