...
The classification drives which specialist skills run if the principal approves.
...
Wait for the principal's explicit response. Silent / ambiguous is not authorization.

### Step 5: Record and hand off

- **If authorized** — record; hand off.
- **If authorized with modifications** — re-summarize for the principal's confirmation.
