...
```css
--gr-typography-lineHeight-none: 1
--gr-typography-lineHeight-tight: 1.25
--gr-typography-lineHeight-snug: 1.375
--gr-typography-lineHeight-normal: 1.5
--gr-typography-lineHeight-relaxed: 1.625
--gr-typography-lineHeight-loose: 2
```

### Font Family

```css
--gr-typography-fontFamily-sans: 'Inter', system-ui, -apple-system, sans-serif
--gr-typography-fontFamily-mono: 'Fira Code', monospace
```
