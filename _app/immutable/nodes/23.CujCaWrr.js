import{n as e}from"../chunks/hePW80VL.js";import{$ as t,C as n,Dt as r,Et as i,F as a,I as o,K as s,L as c,M as l,P as u,R as d,St as f,U as p,at as m,ct as h,d as ee,ft as g,h as te,mt as _,ot as v,st as y,ut as b,xt as x}from"../chunks/xyBo9fw_.js";import"../chunks/xihTtKlq.js";import{B as S,H as ne,Jt as re,R as ie,U as C,V as ae,z as w}from"../chunks/DnPrlpXk.js";import{t as T}from"../chunks/Bv4csXnx.js";import{t as E}from"../chunks/C1qIpVBb.js";var D=e({load:()=>O}),O=(()=>({metadata:{slug:`forms-demo`,title:`Form Components Demo`,description:`Text inputs, selects, switches, checkboxes, radios, and uploads pulled from the production primitives build.`,sections:[`Text inputs`,`Selections`,`Toggles & switches`,`File uploads`]}})),oe=d(`<label class="svelte-109fpqf"><input type="radio" name="audience" class="svelte-109fpqf"/> <span> </span></label>`),se=d(`<li class="svelte-109fpqf"><strong> </strong> <span> </span></li>`),ce=d(`<ul class="file-list svelte-109fpqf"></ul>`),le=d(`<p class="placeholder svelte-109fpqf">No files selected.</p>`),ue=d(`<section class="demo-section svelte-109fpqf"><header><h2>Text Inputs &amp; Validation</h2> <p>Showcases helper text, inline errors, prefix icons, and required indicators.</p></header> <div class="text-inputs svelte-109fpqf"><!> <!></div> <p class="a11y-tip svelte-109fpqf">Accessible pattern: help text is tied via aria-describedby and errors announce with
			...
			order.</p> <!></section> <section class="demo-section svelte-109fpqf"><header><h2>File Upload &amp; Drag-and-Drop</h2> <p>Wrap the published FileUpload control with a drag surface for richer UX while keeping drag
				events in user land.</p></header> <div aria-label="Upload files" role="region"><p class="select-label svelte-109fpqf">Attachments</p> <!> <p>Drag files here or use the button. Up to 4 files.</p></div> <!> <!></section>`,1);function k(e,d){f(d,!0);let D=[],O=g(``),k=g(``),A=g(!1),j=_(()=>()=>s(O).trim().length>0&&s(O).trim().length<2),de=_(()=>()=>/.+@.+\..+/.test(s(k))),M=g(`Greater Components ships with strong defaults.`),fe=_(()=>()=>Math.max(0,280-s(M).length)),N=_(()=>()=>Math.min(10,Math.max(4,Math.ceil(s(M).length/60)))),pe=[{value:``,label:`Select a region`},{value:`us`,label:`United States`},{value:`uk`,label:`United Kingdom`},{value:`br`,label:`Brazil`,disabled:!0},{value:`de`,label:`Germany`},{value:`jp`,label:`Japan`}],P=g(``),F=g(`public`),I=g(!0),L=g(!1),R=g(!0),z=g(h([])),B=g(!1);function me(e){b(z,e?Array.from(e):[],!0)}function he(e){e.preventDefault(),b(B,!1);let t=e.dataTransfer?.files;t&&b(z,Array.from(t),!0)}T(e,{eyebrow:`Component Demos`,get title(){return d.data.metadata.title},get description(){return d.data.metadata.description},children:(e,d)=>{var f=ue(),h=v(f),g=y(m(h),2),x=m(g);C(x,{label:`Display name`,required:!0,helpText:`Shown on profiles and mentions.`,get invalid(){return s(j)},errorMessage:`Use at least two characters.`,get value(){return s(O)},set value(e){b(O,e,!0)},suffix:e=>{var t=c(),n=v(t),r=e=>{re(e,{size:16,"aria-hidden":`true`})},i=_(()=>!s(j)&&s(O).trim().length>=2);u(n,e=>{s(i)&&e(r)}),o(e,t)},$$slots:{suffix:!0}});var T=y(x,2);{let e=_(()=>!s(de)&&s(A));C(T,{label:`Contact email`,type:`email`,placeholder:`you@example.com`,get invalid(){return s(e)},errorMessage:`Enter a valid email so recovery links work.`,onblur:()=>b(A,!0),get value(){return s(k)},set value(e){b(k,e,!0)}})}r(g);var ge=y(g,4);E(ge,{title:`TextField usage`,description:`Snippet mirrors the bindings powering this section.`,code:`
<div class="text-inputs">
  ...
  />
</div>`}),r(h);var V=y(h,2),H=y(m(V),4);ne(H,{id:`bio-field`,get rows(){return s(N)},maxlength:280,placeholder:`Share what admins should know…`,get value(){return s(M)},set value(e){b(M,e,!0)}});var U=y(H,2),W=m(U),_e=m(W);r(W);var G=y(W,2),ve=m(G);r(G),r(U);var ye=y(U,4);E(ye,{title:`Auto-resize TextArea`,description:`Rows derive from the same derived store used by the live textarea.`,code:`
...
/>
<p aria-live="polite">{remaining} characters left</p>`}),r(V);var K=y(V,2),q=y(m(K),2),J=m(q),be=y(m(J),2);ae(be,{id:`visibility-select`,placeholder:`Pick visibility`,get options(){return pe},get value(){return s(P)},set value(e){b(P,e,!0)}}),r(J);var xe=y(J,2),Se=y(m(xe),2);l(Se,16,()=>[`public`,`followers`,`private`],e=>e,(e,i)=>{var c=oe(),l=m(c);te(l);var u,d=y(l,2);let f;var p=m(d,!0);r(d),r(c),t(()=>{u!==(u=i)&&(l.value=(l.__value=i)??``),f=n(d,1,`svelte-109fpqf`,null,f,{active:s(F)===i}),a(p,i)}),ee(D,[],l,()=>s(F),e=>b(F,e)),o(e,c)}),r(xe),r(q);var Ce=y(q,4);E(Ce,{title:`Select + radio`,description:`Native radio inputs pair with Greater Select for full coverage.`,code:`
...
<fieldset role="radiogroup" aria-label="Audience">
  ...
  {/each}
</fieldset>`}),r(K);var Y=y(K,2),X=y(m(Y),2),we=m(X);S(we,{label:`Release newsletter`,get checked(){return s(I)},set checked(e){b(I,e,!0)}});var Te=y(we,2);S(Te,{label:`Join beta`,get checked(){return s(L)},set checked(e){b(L,e,!0)}});var Ee=y(Te,2);w(Ee,{label:`Dark mode`,get checked(){return s(R)},set checked(e){b(R,e,!0)}});var De=y(Ee,2);w(De,{checked:!1,disabled:!0,label:`Switch disabled`}),r(X);var Oe=y(X,4);E(Oe,{title:`Checkbox + Switch`,description:`Live bindings keep snippet parity.`,code:`
...
</div>`}),r(Y);var ke=y(Y,2),Z=y(m(ke),2);let Q;var Ae=y(m(Z),2);ie(Ae,{multiple:!0,accept:`image/*`,onchange:me}),i(2),r(Z);var $=y(Z,2),je=e=>{var n=ce();l(n,21,()=>s(z),e=>e.name,(e,n)=>{var i=se(),c=m(i),l=m(c,!0);r(c);var u=y(c,2),d=m(u);r(u),r(i),t(e=>{a(l,s(n).name),a(d,`${e??``} KB · ${(s(n).type||`Unknown type`)??``}`)},[()=>Math.round(s(n).size/1024)]),o(e,i)}),r(n),o(e,n)},Me=e=>{var t=le();o(e,t)};u($,e=>{s(z).length>0?e(je):e(Me,-1)});var Ne=y($,2);E(Ne,{title:`Drag surface + FileUpload`,description:`Drop zone delegates to FileUpload so uploads continue to flow through the published component.`,code:`
...
<ul>
  {#each uploadedFiles as file}
    <li>{file.name}</li>
  {/each}
</ul>`}),r(ke),t(()=>{a(_e,`${s(N)??``} rows`),a(ve,`${s(fe)??``} characters left`),Q=n(Z,1,`drop-surface svelte-109fpqf`,null,Q,{active:s(B)})}),p(`dragover`,Z,e=>e.preventDefault()),p(`dragenter`,Z,()=>b(B,!0)),p(`dragleave`,Z,()=>b(B,!1)),p(`drop`,Z,he),o(e,f)},$$slots:{default:!0}}),x()}export{k as component,D as universal};