import"../chunks/DsnmJJEf.js";import{p as Ee,m as d,W as Ge,b as _,g as oe,s as a,c as i,l as r,h as e,u as m,t as E,_ as q,a as h,e as Je,d as Ke,r as l,X as Le,j as b}from"../chunks/fhmmTLCl.js";import{i as ne}from"../chunks/Bv8pTBk7.js";import{f as de,s as ce,r as Ve}from"../chunks/hw2FEYC7.js";import{S as Oe,e as pe,F as We,f as Xe}from"../chunks/BHh5kNhB.js";import{D as He}from"../chunks/CjITXy4O.js";import{C as g}from"../chunks/CtKsLE06.js";import{C as Qe}from"../chunks/BByFGNsJ.js";import{T as ve}from"../chunks/CzmPPiTj.js";import{T as Ye}from"../chunks/DE6-4yrL.js";import{S as ue}from"../chunks/DCcCHs5A.js";const Ze=(()=>({metadata:{slug:"forms-demo",title:"Form Components Demo",description:"Text inputs, selects, switches, checkboxes, radios, and uploads pulled from the production primitives build.",sections:["Text inputs","Selections","Toggles & switches","File uploads"]}})),ma=Object.freeze(Object.defineProperty({__proto__:null,load:Ze},Symbol.toStringTag,{value:"Module"}));var ea=_('<label class="svelte-109fpqf"><input type="radio" name="audience" class="svelte-109fpqf"/> <span> </span></label>'),aa=_('<li class="svelte-109fpqf"><strong> </strong> <span> </span></li>'),ta=_('<ul class="file-list svelte-109fpqf"></ul>'),la=_('<p class="placeholder svelte-109fpqf">No files selected.</p>'),ia=_(`<section class="demo-section svelte-109fpqf"><header><h2>Text Inputs &amp; Validation</h2> <p>Showcases helper text, inline errors, prefix icons, and required indicators.</p></header> <div class="text-inputs svelte-109fpqf"><!> <!></div> <p class="a11y-tip svelte-109fpqf">Accessible pattern: help text is tied via aria-describedby and errors announce with
			...
			order.</p> <!></section> <section class="demo-section svelte-109fpqf"><header><h2>File Upload &amp; Drag-and-Drop</h2> <p>Wrap the published FileUpload control with a drag surface for richer UX while keeping drag
				events in user land.</p></header> <div aria-label="Upload files" role="region"><p class="select-label svelte-109fpqf">Attachments</p> <!> <p>Drag files here or use the button. Up to 4 files.</p></div> <!> <!></section>`,1);function ba(he,D){Ee(D,!0);const fe=[];let f=d(""),T=d(""),G=d(!1);const J=m(()=>()=>e(f).trim().length>0&&e(f).trim().length<2),me=m(()=>()=>/.+@.+\..+/.test(e(T))),be=`
