import"../chunks/DsnmJJEf.js";import{p as Le,i as d,L as Ee,b as _,x as oe,j as r,g as e,u as m,d as i,s as a,t as L,M as q,a as h,w as Ge,c as Je,e as l,h as b,z as Ke}from"../chunks/By1FN8TE.js";import{i as ne}from"../chunks/BqliM4dK.js";import{S as Ve,h as de,C as ce,F as Oe,r as We,s as pe,i as Xe}from"../chunks/Ce6awIAQ.js";import{D as He}from"../chunks/1ISensnS.js";import{C as g}from"../chunks/DGsFK5CB.js";import{T as ve}from"../chunks/VQDXQMd6.js";import{T as Qe}from"../chunks/DGr7B-JF.js";import{S as ue}from"../chunks/BArm17mj.js";import{C as Ye}from"../chunks/bonSSVEm.js";const Ze=(()=>({metadata:{slug:"forms-demo",title:"Form Components Demo",description:"Text inputs, selects, switches, checkboxes, radios, and uploads pulled from the production primitives build.",sections:["Text inputs","Selections","Toggles & switches","File uploads"]}})),fa=Object.freeze(Object.defineProperty({__proto__:null,load:Ze},Symbol.toStringTag,{value:"Module"}));var ea=_('<label class="svelte-109fpqf"><input type="radio" name="audience" class="svelte-109fpqf"/> <span> </span></label>'),aa=_('<li class="svelte-109fpqf"><strong> </strong> <span> </span></li>'),ta=_('<ul class="file-list svelte-109fpqf"></ul>'),la=_('<p class="placeholder svelte-109fpqf">No files selected.</p>'),ia=_(`<section class="demo-section svelte-109fpqf"><header><h2>Text Inputs &amp; Validation</h2> <p>Showcases helper text, inline errors, prefix icons, and required indicators.</p></header> <div class="text-inputs svelte-109fpqf"><!> <!></div> <p class="a11y-tip svelte-109fpqf">Accessible pattern: help text is tied via aria-describedby and errors announce with
			...
			order.</p> <!></section> <section class="demo-section svelte-109fpqf"><header><h2>File Upload &amp; Drag-and-Drop</h2> <p>Wrap the published FileUpload control with a drag surface for richer UX while keeping drag
				events in user land.</p></header> <div aria-label="Upload files" role="region"><p class="select-label svelte-109fpqf">Attachments</p> <!> <p>Drag files here or use the button. Up to 4 files.</p></div> <!> <!></section>`,1);function ma(he,D){Le(D,!0);const fe=[];let f=d(""),T=d(""),E=d(!1);const G=m(()=>()=>e(f).trim().length>0&&e(f).trim().length<2),me=m(()=>()=>/.+@.+\..+/.test(e(T))),be=`
<div class="text-inputs">
  ...
  />
</div>`;let w=d("Greater Components ships with strong defaults.");const J=280,ge=m(()=>()=>Math.max(0,J-e(w).length)),K=m(()=>()=>Math.min(10,Math.max(4,Math.ceil(e(w).length/60)))),_e=`
...
<ul>
  {#each uploadedFiles as file}
    <li>{file.name}</li>
  {/each}
</ul>`;He(he,{eyebrow:"Component Demos",get title(){return D.data.metadata.title},get description(){return D.data.metadata.description},children:(u,C)=>{var H=ia(),F=oe(H),U=a(i(F),2),Q=i(U);ve(Q,{label:"Display name",required:!0,helpText:"Shown on profiles and mentions.",get invalid(){return e(G)},errorMessage:"Use at least two characters.",get value(){return e(f)},set value(s){r(f,s,!0)},suffix:s=>{var c=Ge(),o=oe(c);{var v=n=>{Ye(n,{size:16,"aria-hidden":"true"})};ne(o,n=>{!e(G)&&e(f).trim().length>=2&&n(v)})}h(s,c)},$$slots:{suffix:!0}});var De=a(Q,2);{let t=m(()=>!e(me)&&e(E));ve(De,{label:"Contact email",type:"email",placeholder:"you@example.com",get invalid(){return e(t)},errorMessage:"Enter a valid email so recovery links work.",onblur:()=>r(E,!0),get value(){return e(T)},set value(s){r(T,s,!0)}})}l(U);var Te=a(U,4);g(Te,{title:"TextField usage",description:"Snippet mirrors the bindings powering this section.",code:be}),l(F);var M=a(F,2),Y=a(i(M),4);Qe(Y,{id:"bio-field",get rows(){return e(K)},maxlength:J,placeholder:"Share what admins should know…",get value(){return e(w)},set value(t){r(w,t,!0)}});var z=a(Y,2),R=i(z),Ae=i(R);l(R);var Z=a(R,2),Ce=i(Z);l(Z),l(z);var Fe=a(z,4);g(Fe,{title:"Auto-resize TextArea",description:"Rows derive from the same derived store used by the live textarea.",code:_e}),l(M);var N=a(M,2),P=a(i(N),2),$=i(P),Ue=a(i($),2);Ve(Ue,{id:"visibility-select",placeholder:"Pick visibility",get options(){return we},get value(){return e(V)},set value(t){r(V,t,!0)}}),l($);var ee=a($,2),Me=a(i(ee),2);de(Me,16,()=>["public","followers","private"],t=>t,(t,s)=>{var c=ea(),o=i(c);We(o);var v,n=a(o,2);let k;var S=i(n,!0);l(n),l(c),L(()=>{v!==(v=s)&&(o.value=(o.__value=s)??""),k=pe(n,1,"svelte-109fpqf",null,k,{active:e(A)===s}),b(S,s)}),Xe(fe,[],o,()=>e(A),B=>r(A,B)),h(t,c)}),l(ee),l(P);var ze=a(P,4);g(ze,{title:"Select + radio",description:"Native radio inputs pair with Greater Select for full coverage.",code:ye}),l(N);var j=a(N,2),I=a(i(j),2),ae=i(I);ce(ae,{label:"Release newsletter",get checked(){return e(O)},set checked(t){r(O,t,!0)}});var te=a(ae,2);ce(te,{label:"Join beta",get checked(){return e(W)},set checked(t){r(W,t,!0)}});var le=a(te,2);ue(le,{label:"Dark mode",get checked(){return e(X)},set checked(t){r(X,t,!0)}});var Re=a(le,2);ue(Re,{checked:!1,disabled:!0,label:"Switch disabled"}),l(I);var Ne=a(I,4);g(Ne,{title:"Checkbox + Switch",description:"Live bindings keep snippet parity.",code:xe}),l(j);var ie=a(j,2),p=a(i(ie),2);let se;var Pe=a(i(p),2);Oe(Pe,{multiple:!0,accept:"image/*",onchange:ke}),Ke(2),l(p);var re=a(p,2);{var $e=t=>{var s=ta();de(s,21,()=>e(y),c=>c.name,(c,o)=>{var v=aa(),n=i(v),k=i(n,!0);l(n);var S=a(n,2),B=i(S);l(S),l(v),L(Be=>{b(k,e(o).name),b(B,`${Be??""} KB · ${(e(o).type||"Unknown type")??""}`)},[()=>Math.round(e(o).size/1024)]),h(c,v)}),l(s),h(t,s)},je=t=>{var s=la();h(t,s)};ne(re,t=>{e(y).length>0?t($e):t(je,!1)})}var Ie=a(re,2);g(Ie,{title:"Drag surface + FileUpload",description:"Drop zone delegates to FileUpload so uploads continue to flow through the published component.",code:qe}),l(ie),L(()=>{b(Ae,`${e(K)??""} rows`),b(Ce,`${e(ge)??""} characters left`),se=pe(p,1,"drop-surface svelte-109fpqf",null,se,{active:e(x)})}),q("dragover",p,t=>t.preventDefault()),q("dragenter",p,()=>r(x,!0)),q("dragleave",p,()=>r(x,!1)),q("drop",p,Se),h(u,H)},$$slots:{default:!0}}),Je()}export{ma as component,fa as universal};
