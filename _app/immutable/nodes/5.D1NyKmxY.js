import"../chunks/DsnmJJEf.js";import{p as ge,k as M,y as xe,b as G,h as y,s as i,q as _,t as B,a as n,g as t,d as l,l as p,z as X,c as ye,v as $,j as I,u as _e,r as o,e as U}from"../chunks/CRFS9uw3.js";import{h as P,B as u}from"../chunks/CtNyN7v0.js";import{i as Y}from"../chunks/DsRRuAWK.js";import{c as E}from"../chunks/DGnHAPP9.js";import{D as $e}from"../chunks/WBNmjzQa.js";import{C as F}from"../chunks/CmUtWeOf.js";import{A as Se}from"../chunks/C8BAm0FO.js";import{C as qe}from"../chunks/BM8-uJ_L.js";import{S as Be,P as Ie,L as Pe}from"../chunks/DkZpBD8Y.js";import{S as ke}from"../chunks/CPaO1ZAw.js";const ze=(()=>({metadata:{slug:"button-demo",title:"Button Patterns",description:"Comprehensive coverage of Greater button variants, states, and icon affordances rendered from the published primitives package.",sections:["Variants & sizes","Icon placements","Stateful interactions"]}})),Ge=Object.freeze(Object.defineProperty({__proto__:null,load:ze},Symbol.toStringTag,{value:"Module"}));var Ce=G("<!> <!>",1),we=G("<li> </li>"),De=G(`<section class="demo-section svelte-ocucxq"><header class="svelte-ocucxq"><h2 class="svelte-ocucxq">Variants &amp; Sizes</h2> <p>Solid, outline, and ghost buttons rendered directly from the published primitives package in
			...
			progress textually as well.</p> <!></section>`,1);function Ne(Z,k){ge(k,!0);const ee=["solid","outline","ghost"],te=["sm","md","lg"],ae=ee.flatMap(r=>te.map(S=>({id:`${r}-${S}`,label:`${r.charAt(0).toUpperCase()+r.slice(1)} · ${S.toUpperCase()}`,variant:r,size:S}))),se=`
<div class="button-grid">
  ...
  {/each}
</div>`,ie=[{id:"primary-prefix",label:"Share update",variant:"solid",affix:"prefix",Icon:Be},{id:"secondary-suffix",label:"Continue",variant:"outline",affix:"suffix",Icon:Se},{id:"success-prefix",label:"Confirm",variant:"solid",affix:"prefix",Icon:qe}],oe=[{id:"settings",label:"Open settings",Icon:ke},{id:"play",label:"Play media",Icon:Ie},{id:"refresh",label:"Refresh board",Icon:Pe}],ne=`
<div class="icon-demo">
