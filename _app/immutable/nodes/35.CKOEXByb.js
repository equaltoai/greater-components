...
<SignInCard 
  ...
  {error}
  onRetry={() => error = null}
/>`,language:`svelte`}),t(c);var m=u(c,2),y=u(s(m),4),E=s(y);g(E,{title:`Sign in to continue`,get providers(){return b},onSignIn:w,footer:e=>{var t=_();n(2),r(e,t)},$$slots:{footer:!0}}),t(y);var D=u(y,2);h(D,{code:`<SignInCard 
...
>
  ...
  {/snippet}
</SignInCard>`,language:`svelte`}),t(m);var O=u(m,4),k=u(s(O),2);h(k,{code:`interface OAuthProvider {
...
}`,language:`typescript`}),t(O),n(2),r(e,o)},$$slots:{actions:!0,default:!0}}),f()}export{y as component};