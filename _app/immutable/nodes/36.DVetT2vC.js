...
<UserButton {user} onSignOut={handleSignOut} size="lg" />`;R(w,{eyebrow:"Auth Components",title:"User Button",description:"Authenticated user avatar with dropdown menu for profile actions and sign-out functionality.",children:(c,ee)=>{var S=Z(),d=E(S),x=e(t(d),4),P=t(x);a(P,{get user(){return n},onSignOut:r,get menuItems(){return b},get loading(){return C(l)}}),s(x);var A=e(x,2);o(A,{code:z,language:"svelte"}),s(d);var v=e(d,2),u=e(t(v),4),j=t(u);a(j,{get user(){return n},onSignOut:r,variant:"inline",get loading(){return C(l)}}),s(u);var q=e(u,2);o(q,{code:D,language:"svelte"}),s(v);var m=e(v,2),_=e(t(m),4),$=t(_);a($,{get user(){return I},onSignOut:r,get menuItems(){return b}}),s(_),s(m);var g=e(m,2),p=e(t(g),4),h=t(p),F=t(h);a(F,{get user(){return n},onSignOut:r,size:"sm"}),i(2),s(h);var f=e(h,2),H=t(f);a(H,{get user(){return n},onSignOut:r,size:"md"}),i(2),s(f);var U=e(f,2),J=t(U);a(J,{get user(){return n},onSignOut:r,size:"lg"}),i(2),s(U),s(p);var L=e(p,2);o(L,{code:B,language:"svelte"}),s(g);var O=e(g,4),M=e(t(O),2);o(M,{code:`interface UserMenuItem {
...
}`,language:"typescript"}),s(O),i(2),T(c,S)},$$slots:{default:!0}}),K()}export{de as component};
