import"../chunks/DsnmJJEf.js";import{p as Ee,k as d,y as Ge,b as _,h as oe,l as r,g as e,u as m,d as i,s as a,t as E,z as q,a as h,e as Je,c as Ke,r as l,j as b,v as Le}from"../chunks/CRFS9uw3.js";import{S as Ve,h as ne,n as de,F as Oe,r as We,b as ce,o as Xe}from"../chunks/CtNyN7v0.js";import{i as pe}from"../chunks/DsRRuAWK.js";import{D as He}from"../chunks/WBNmjzQa.js";import{C as g}from"../chunks/CmUtWeOf.js";import{C as Qe}from"../chunks/BM8-uJ_L.js";import{T as ve}from"../chunks/BBK_fAZu.js";import{T as Ye}from"../chunks/DvAVqOrL.js";import{S as ue}from"../chunks/Bi_L0gfQ.js";const Ze=(()=>({metadata:{slug:"forms-demo",title:"Form Components Demo",description:"Text inputs, selects, switches, checkboxes, radios, and uploads pulled from the production primitives build.",sections:["Text inputs","Selections","Toggles & switches","File uploads"]}})),fa=Object.freeze(Object.defineProperty({__proto__:null,load:Ze},Symbol.toStringTag,{value:"Module"}));var ea=_('<label class="svelte-109fpqf"><input type="radio" name="audience" class="svelte-109fpqf"/> <span> </span></label>'),aa=_('<li class="svelte-109fpqf"><strong> </strong> <span> </span></li>'),ta=_('<ul class="file-list svelte-109fpqf"></ul>'),la=_('<p class="placeholder svelte-109fpqf">No files selected.</p>'),ia=_(`<section class="demo-section svelte-109fpqf"><header><h2>Text Inputs &amp; Validation</h2> <p>Showcases helper text, inline errors, prefix icons, and required indicators.</p></header> <div class="text-inputs svelte-109fpqf"><!> <!></div> <p class="a11y-tip svelte-109fpqf">Accessible pattern: help text is tied via aria-describedby and errors announce with
			...
			order.</p> <!></section> <section class="demo-section svelte-109fpqf"><header><h2>File Upload &amp; Drag-and-Drop</h2> <p>Wrap the published FileUpload control with a drag surface for richer UX while keeping drag
				events in user land.</p></header> <div aria-label="Upload files" role="region"><p class="select-label svelte-109fpqf">Attachments</p> <!> <p>Drag files here or use the button. Up to 4 files.</p></div> <!> <!></section>`,1);function ma(he,D){Ee(D,!0);const fe=[];let f=d(""),T=d(""),G=d(!1);const J=m(()=>()=>e(f).trim().length>0&&e(f).trim().length<2),me=m(()=>()=>/.+@.+\..+/.test(e(T))),be=`
<div class="text-inputs">
  ...
  />
</div>`;let w=d("Greater Components ships with strong defaults.");const K=280,ge=m(()=>()=>Math.max(0,K-e(w).length)),L=m(()=>()=>Math.min(10,Math.max(4,Math.ceil(e(w).length/60)))),_e=`
...
</div>`;let y=d(Ge([])),x=d(!1);function ke(u){r(y,u?Array.from(u):[],!0)}function Se(u){u.preventDefault(),r(x,!1);const C=u.dataTransfer?.files;C&&r(y,Array.from(C),!0)}const qe=`
...
<ul>
  {#each uploadedFiles as file}
    <li>{file.name}</li>
  {/each}
</ul>`;He(he,{eyebrow:"Component Demos",get title(){return D.data.metadata.title},get description(){return D.data.metadata.description},children:(u,C)=>{var H=ia(),F=oe(H),U=a(i(F),2),Q=i(U);ve(Q,{label:"Display name",required:!0,helpText:"Shown on profiles and mentions.",get invalid(){return e(J)},errorMessage:"Use at least two characters.",get value(){return e(f)},set value(s){r(f,s,!0)},suffix:s=>{var c=Je(),o=oe(c);{var v=n=>{Qe(n,{size:16,"aria-hidden":"true"})};pe(o,n=>{!e(J)&&e(f).trim().length>=2&&n(v)})}h(s,c)},$$slots:{suffix:!0}});var De=a(Q,2);{let t=m(()=>!e(me)&&e(G));ve(De,{label:"Contact email",type:"email",placeholder:"you@example.com",get invalid(){return e(t)},errorMessage:"Enter a valid email so recovery links work.",onblur:()=>r(G,!0),get value(){return e(T)},set value(s){r(T,s,!0)}})}l(U);var Te=a(U,4);g(Te,{title:"TextField usage",description:"Snippet mirrors the bindings powering this section.",code:be}),l(F);var M=a(F,2),Y=a(i(M),4);Ye(Y,{id:"bio-field",get rows(){return e(L)},maxlength:K,placeholder:"Share what admins should know…",get value(){return e(w)},set value(t){r(w,t,!0)}});var z=a(Y,2),R=i(z),Ae=i(R);l(R);var Z=a(R,2),Ce=i(Z);l(Z),l(z);var Fe=a(z,4);g(Fe,{title:"Auto-resize TextArea",description:"Rows derive from the same derived store used by the live textarea.",code:_e}),l(M);var N=a(M,2),P=a(i(N),2),$=i(P),Ue=a(i($),2);Ve(Ue,{id:"visibility-select",placeholder:"Pick visibility",get options(){return we},get value(){return e(V)},set value(t){r(V,t,!0)}}),l($);var ee=a($,2),Me=a(i(ee),2);ne(Me,16,()=>["public","followers","private"],t=>t,(t,s)=>{var c=ea(),o=i(c);We(o);var v,n=a(o,2);let k;var S=i(n,!0);l(n),l(c),E(()=>{v!==(v=s)&&(o.value=(o.__value=s)??""),k=ce(n,1,"svelte-109fpqf",null,k,{active:e(A)===s}),b(S,s)}),Xe(fe,[],o,()=>e(A),B=>r(A,B)),h(t,c)}),l(ee),l(P);var ze=a(P,4);g(ze,{title:"Select + radio",description:"Native radio inputs pair with Greater Select for full coverage.",code:ye}),l(N);var j=a(N,2),I=a(i(j),2),ae=i(I);de(ae,{label:"Release newsletter",get checked(){return e(O)},set checked(t){r(O,t,!0)}});var te=a(ae,2);de(te,{label:"Join beta",get checked(){return e(W)},set checked(t){r(W,t,!0)}});var le=a(te,2);ue(le,{label:"Dark mode",get checked(){return e(X)},set checked(t){r(X,t,!0)}});var Re=a(le,2);ue(Re,{checked:!1,disabled:!0,label:"Switch disabled"}),l(I);var Ne=a(I,4);g(Ne,{title:"Checkbox + Switch",description:"Live bindings keep snippet parity.",code:xe}),l(j);var ie=a(j,2),p=a(i(ie),2);let se;var Pe=a(i(p),2);Oe(Pe,{multiple:!0,accept:"image/*",onchange:ke}),Le(2),l(p);var re=a(p,2);{var $e=t=>{var s=ta();ne(s,21,()=>e(y),c=>c.name,(c,o)=>{var v=aa(),n=i(v),k=i(n,!0);l(n);var S=a(n,2),B=i(S);l(S),l(v),E(Be=>{b(k,e(o).name),b(B,`${Be??""} KB · ${(e(o).type||"Unknown type")??""}`)},[()=>Math.round(e(o).size/1024)]),h(c,v)}),l(s),h(t,s)},je=t=>{var s=la();h(t,s)};pe(re,t=>{e(y).length>0?t($e):t(je,!1)})}var Ie=a(re,2);g(Ie,{title:"Drag surface + FileUpload",description:"Drop zone delegates to FileUpload so uploads continue to flow through the published component.",code:qe}),l(ie),E(()=>{b(Ae,`${e(L)??""} rows`),b(Ce,`${e(ge)??""} characters left`),se=ce(p,1,"drop-surface svelte-109fpqf",null,se,{active:e(x)})}),q("dragover",p,t=>t.preventDefault()),q("dragenter",p,()=>r(x,!0)),q("dragleave",p,()=>r(x,!1)),q("drop",p,Se),h(u,H)},$$slots:{default:!0}}),Ke()}export{ma as component,fa as universal};
