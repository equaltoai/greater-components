import"../chunks/DsnmJJEf.js";import{N as xe,p as je,i as P,L as Se,o as ke,b as U,x as we,d as t,s as e,y as V,a as u,t as Me,c as Te,j as $,z as G,e as o,h as i,g as n}from"../chunks/By1FN8TE.js";import{D as Ce}from"../chunks/1ISensnS.js";import{C as g}from"../chunks/DGsFK5CB.js";import{B as H}from"../chunks/CO4DoVo0.js";import{p as D,g as J,j as Q}from"../chunks/Ce6awIAQ.js";const Pe=(()=>({metadata:{slug:"interactive-demo",title:"Interactive Components Demo",description:"Menus, context menus, and theming utilities wired to the published primitives package.",sections:["Menus & context menus","Theme switcher variants","Theme provider guidance"]}})),Ke=Object.freeze(Object.defineProperty({__proto__:null,load:Pe},Symbol.toStringTag,{value:"Module"}));var $e=U('<div class="context-target svelte-ojylog" role="button" tabindex="0">Right click or press Shift+F10</div>'),De=U(`<section class="demo-section svelte-ojylog"><header class="svelte-ojylog"><h2>Menu &amp; Keyboard Navigation</h2> <p class="svelte-ojylog">Primary dropdown plus a nested submenu showcase roving tabindex, typeahead, and disabled
...
<ThemeProvider enableSystemDetection preventFlash>
  <slot />
</ThemeProvider>`;Ce(X,{eyebrow:"Component Demos",get title(){return h.data.metadata.title},get description(){return h.data.metadata.description},children:(a,Ie)=>{var F=De(),m=we(F),y=e(t(m),2),z=t(y);J(z,{get items(){return Y},onItemSelect:ee,trigger:(p,l)=>{let d=()=>l?.().open,r=()=>l?.().toggle;H(p,{get"aria-expanded"(){return d()},"aria-haspopup":"true",get onclick(){return r()},children:(s,Be)=>{G();var _e=V("Account actions");u(s,_e)},$$slots:{default:!0}})},$$slots:{trigger:!0}});var R=e(z,2),ie=t(R,!0);o(R),o(y);var ne=e(y,4);g(ne,{title:"Menu trigger",description:"Trigger snippet receives the menu open state and toggle handler.",code:se}),o(m);var f=e(m,2),A=e(t(f),2);J(A,{get items(){return Z},onItemSelect:te,trigger:(p,l)=>{let d=()=>l?.().toggle;var r=$e();r.__contextmenu=s=>{s.preventDefault(),d()()},r.__click=function(...s){d()?.apply(this,s)},r.__keydown=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),d()())},u(p,r)},$$slots:{trigger:!0}});var b=e(A,2),ce=t(b,!0);o(b);var de=e(b,4);g(de,{title:"Context trigger",description:"Wrap any surface and pair the contextmenu event with the menu toggle.",code:ae}),o(f);var _=e(f,2),x=e(t(_),2),j=t(x),ve=e(t(j),2);Q(ve,{variant:"compact",onThemeChange:v}),o(j);var S=e(j,2),pe=e(t(S),2);Q(pe,{variant:"full",showAdvanced:!0,onThemeChange:v}),o(S);var E=e(S,2),k=e(t(E),2),w=t(k),N=e(t(w),2),ue=t(N,!0);o(N),o(w);var M=e(w,2),K=e(t(M),2),ge=t(K,!0);o(K),o(M);var T=e(M,2),O=e(t(T),2),he=t(O,!0);o(O),o(T);var W=e(T,2),q=e(t(W),2),me=t(q,!0);o(q),o(W),o(k);var ye=e(k,2);H(ye,{size:"sm",variant:"outline",onclick:oe,children:(C,p)=>{G();var l=V("Reset preferences");u(C,l)},$$slots:{default:!0}}),o(E),o(x);var fe=e(x,4);g(fe,{title:"Theme switchers",description:"Both variants consume the same published component.",code:le}),o(_);var L=e(_,2),be=e(t(L),4);g(be,{title:"App shell usage",description:"Import from the published primitives build—no local source paths.",code:re}),o(L),Me(()=>{i(ie,n(I)),i(ce,n(B)),i(ue,n(c).resolvedColorScheme),i(ge,n(c).density),i(he,n(c).fontSize),i(me,n(c).motion)}),u(a,F)},$$slots:{default:!0}}),Te()}xe(["contextmenu","click","keydown"]);export{Oe as component,Ke as universal};
