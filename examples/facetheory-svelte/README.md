...
The workspace pins FaceTheory `v4.0.5` for this example so Greater stays aligned with the current Theory Cloud platform release and consumes the built FaceTheory package artifact rather than a source checkout.
