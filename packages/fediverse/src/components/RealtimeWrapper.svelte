...
<script lang="ts">
  ...
  import type { TimelineIntegrationConfig, NotificationIntegrationConfig } from '../lib/integration';
  ...
  let timelineIntegration = component === 'timeline' ? createTimelineIntegration(integration as TimelineIntegrationConfig) : null;
  let notificationIntegration = component === 'notifications' ? createNotificationIntegration(integration as NotificationIntegrationConfig) : null;
