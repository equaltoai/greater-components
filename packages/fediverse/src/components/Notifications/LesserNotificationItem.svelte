...
<style>
	...
	.lesser-notification-item {
		...
		font: inherit;
		display: flex;
		gap: var(--notification-spacing, 0.75rem);
		padding: var(--notification-padding, 1rem);
		background: var(--notification-bg, #ffffff);
		border-bottom: 1px solid var(--notification-border, #e1e8ed);
		cursor: pointer;
		transition: background 0.2s;
	}

	.lesser-notification-item:hover {
		background: var(--notification-bg-hover, #f7f9fa);
	}

	.lesser-notification-item.unread {
		background: var(--notification-bg-unread, #eff6ff);
	}

	.lesser-notification-item:focus {
		outline: 2px solid var(--notification-focus, #3b82f6);
		outline-offset: -2px;
	}

	.lesser-notification-item__icon {
		flex-shrink: 0;
		width: 40px;
		height: 40px;
		display: flex;
	...
	.lesser-notification-item__icon svg {
		width: 24px;
		height: 24px;
		position: relative;
		z-index: 1;
	...
	.lesser-notification-item__content {
		flex: 1;
		min-width: 0;
	}

	.lesser-notification-item__header {
		display: flex;
	...
	.lesser-notification-item__account {
		font-weight: 600;
		color: var(--notification-text-primary, #0f1419);
	}

	.lesser-notification-item__time {
		font-size: 0.875rem;
		color: var(--notification-text-secondary, #536471);
	}

	.lesser-notification-item__body {
		display: flex;
		flex-direction: column;
		gap: 0.5rem;
	}

	.lesser-notification-item__text {
		margin: 0;
		font-size: 0.9375rem;
		color: var(--notification-text-primary, #0f1419);
	}

	.lesser-notification-item__quote,
	.lesser-notification-item__note {
		padding: 0.75rem;
	...
	.lesser-notification-item__note-stats {
		display: flex;
		gap: 1rem;
		margin-top: 0.5rem;
		font-size: 0.875rem;
	...
	.trust-score {
		font-weight: 600;
		color: var(--notification-trust-color, #10b981);
	}

	.trust-score--new {
		color: var(--notification-trust-new-color, #3b82f6);
	}

	.lesser-notification-item__reason,
	.lesser-notification-item__message {
		margin: 0;
		font-size: 0.875rem;
		color: var(--notification-text-secondary, #536471);
	}
