...
```typescript
import type { ActivityPubActor } from '@greater/fediverse/generics';
...
```typescript
import type { ActivityPubObject } from '@greater/fediverse/generics';
...
```typescript
import { MastodonAdapter } from '@greater/fediverse/generics/adapters';
import type { MastodonStatus } from '@greater/fediverse/generics/adapters';
...
```typescript
import { PleromaAdapter } from '@greater/fediverse/generics/adapters';
...
```typescript
import { LesserAdapter } from '@greater/fediverse/generics/adapters';
...
```typescript
import { autoDetectAdapter } from '@greater/fediverse/generics/adapters';
...
```typescript
import type { ActivityPubActor } from '@greater/fediverse/generics';
import type { MastodonExtensions } from '@greater/fediverse/generics/adapters';
...
import {
  ...
  isAnnounce,
  isFollow
} from '@greater/fediverse/generics';
...
```typescript
import { extractActor, extractObject } from '@greater/fediverse/generics';
...
```typescript
import { parseTimestamp } from '@greater/fediverse/generics';
...
```typescript
import { getVisibility } from '@greater/fediverse/generics';
...
```typescript
import type { GenericAdapter, GenericStatus } from '@greater/fediverse/generics';
