...
export const mockStatus: Status = {
	...
	account: mockAccount,
	content:
		'<p>Just released a new version of my <a href="#opensource">#opensource</a> project! Check it out at <a href="https://github.com/alice/project">github.com/alice/project</a> 🚀</p><p>Thanks to everyone who contributed!</p>',
...
export function generateMockGroupedNotifications(): Notification[] {
	...
	return notifications
		.concat(generateMockNotifications(10))
