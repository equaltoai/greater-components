...
describe('ComposeBox', () => {
    ...
    it('saves draft to localStorage', async () => {
        ...
        render(ComposeBox, { props: { onDraftSave, draftKey: 'test-draft' } });
        ...
        expect(localStorage.setItem).toHaveBeenCalledWith('test-draft', expect.stringContaining('Draft content'));
    ...
    it('handles media attachments', async () => {
        ...
        const { container } = render(ComposeBox, { props: { onMediaUpload } });
