...
describe('OfflineStore', () => {
	...
	describe('Initialization', () => {
		...
		it('loads saved artworks from IndexedDB', async () => {
            ...
            expect(utils.loadFromIndexedDB).toHaveBeenCalledWith(expect.any(String), 'saved-artworks', 'artworks');
		});
	});
	...
	describe('Artwork Persistence', () => {
		it('saves artwork', async () => {
            ...
            expect(utils.persistToIndexedDB).toHaveBeenCalledWith(expect.any(String), 'saved-artworks', 'artworks', expect.any(Array));
		});
	...
	describe('Sync Queue', () => {
		it('queues action', async () => {
            ...
            expect(utils.persistToIndexedDB).toHaveBeenCalledWith(expect.any(String), 'sync-queue', 'queue', expect.any(Array));
		});
