...
describe('accessibility Utils', () => {
	...
	describe('stateChangeAnnouncement', () => {
		it('formats announcement', () => {
			expect(stateChangeAnnouncement('Saved', 'Collection', 'Private'))
				.toBe('Collection Saved: Private');
		});
	});

	describe('galleryAnnouncement', () => {
		it('formats gallery info', () => {
			expect(galleryAnnouncement(10, 1, 5, 'Main'))
				.toBe('Main gallery, 10 artworks, row 1 of 5');
		});
	});
