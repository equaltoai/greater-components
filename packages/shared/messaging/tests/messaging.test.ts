...
describe('NewConversation', () => {
    ...
    it('opens modal and handles search empty results', async () => {
        ...
        expect(target.querySelector('.new-conversation__empty')?.textContent).toContain('No users found');
    ...
    it('handles creation failure', async () => {
        const target = document.createElement('div');
        const instance = mount(NewConversation, { target, props: { 
        ...
        expect(target.querySelector('.new-conversation__error')?.textContent).toContain('Create failed');
...
describe('Messaging Smoke Tests', () => {
    ...
    it('renders Message', () => {
        ...
        expect(target.querySelector('.messages-message') || target.querySelector('.message')).toBeTruthy(); // Check correct class
