...
function shouldShowEmptyState(notifications: Notification[], loading: boolean): boolean {
...
function filterByReadStatus(notifications: Notification[], unreadOnly: boolean): Notification[] {
...
describe('NotificationsFeed - Notification Checks', () => {
	...
	it('detects has unread', () => {
		const notifications = [createNotification({ read: true }), createNotification({ read: false })];
...
describe('NotificationsFeed - Filtering', () => {
	...
	it('returns all when not filtering', () => {
		const notifications = [createNotification({ read: false }), createNotification({ read: true })];
