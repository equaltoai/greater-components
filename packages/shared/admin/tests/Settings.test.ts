...
function hasSettingsChanged(original: InstanceSettings, edited: InstanceSettings): boolean {
...
function hasDangerousSettings(settings: InstanceSettings): boolean {
	return settings.registrationOpen && !settings.approvalRequired && !settings.inviteOnly;
}
...
function isFieldDisabled(field: 'approvalRequired', settings: InstanceSettings): boolean {
