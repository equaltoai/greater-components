...
export function testScreenReaderAnnouncement(
	...
	const passed = actualAnnouncement.toLowerCase().includes(expectedAnnouncement.toLowerCase());
 ...
 */
export function generateScreenReaderReport(results: ScreenReaderTestResult[]): string {
