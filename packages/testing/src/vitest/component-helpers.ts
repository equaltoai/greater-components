...
type ViNamespace = (typeof import('vitest'))['vi'];
type MockFn = ReturnType<ViNamespace['fn']>;

interface ComponentMockMap {
	onClose: MockFn;
	onClick: MockFn;
	onFocus: MockFn;
	onBlur: MockFn;
...
export function renderWithA11yContext(
	...
	return (props !== undefined
		? render(ComponentCtor, props)
		: render(ComponentCtor)) as unknown as ReturnType<typeof render>;
}
 ...
 */
export async function createComponentMocks(): Promise<ComponentMockMap> {
