 ...
 */
export function createMockA11yPreferencesStore(
	initialPrefs: Partial<{
		reducedMotion: boolean;
		highContrast: boolean;
		fontSize: number;
	...
	return {
		...
		updatePreference<K extends keyof typeof currentPrefs>(key: K, value: (typeof currentPrefs)[K]) {
