...
test.describe('Artist Face demo', () => {
	test.describe('Artwork', () => {
        ...
        test('page renders', async ({ page }) => {
            ...
            await expect(page.getByRole('heading', { name: 'Artwork Components', level: 1 })).toBeVisible();
            // Check H2 from content
            await expect(page.getByRole('heading', { name: 'Artwork Compound Component', level: 2 })).toBeVisible();
        });
	...
	test.describe('Gallery', () => {
        ...
        test('page renders', async ({ page }) => {
            await expect(page.getByRole('heading', { name: 'Gallery Components', level: 1 })).toBeVisible();
