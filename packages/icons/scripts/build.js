...
const existingSocialIcons = ['github', 'gitlab', 'slack', 'linkedin', 'twitter', 'facebook', 'instagram', 'youtube', 'twitch'];
...
console.warn(`  - Total icons: ${featherIconNames.length + fediverseIconNames.length + brandIconNames.length}`);
