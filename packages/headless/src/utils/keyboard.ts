 ...
 */
export function getArrowKeyDirection(event: KeyboardEvent): 'up' | 'down' | 'left' | 'right' | null {
  switch (event.key) {
    case 'ArrowUp':
      return 'up';
    case 'ArrowDown':
 ...
 */
export function getNavigationDirection(event: KeyboardEvent, orientation: 'horizontal' | 'vertical' = 'vertical'): NavigationDirection | null {
