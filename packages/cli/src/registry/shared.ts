...
export const sharedModuleRegistry: Record<string, SharedModuleMetadata> = {
	...
	notifications: {
		...
		exports: ['Root', 'Item', 'Group', 'Filter', 'LesserNotificationItem'],
		files: [
			...
			{ path: 'shared/notifications/context.ts', content: '', type: 'types' },
		],
		dependencies: [{ name: 'svelte', version: '^5.0.0' }],
		devDependencies: [],
	...
	search: {
		...
		files: [
			...
			{ path: 'shared/search/context.ts', content: '', type: 'types' },
		],
		dependencies: [{ name: 'svelte', version: '^5.0.0' }],
		devDependencies: [],
		registryDependencies: ['button'],
	...
	chat: {
		...
		files: [
			{ path: 'shared/chat/Container.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/Messages.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/Message.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/Input.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/Header.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/ToolCall.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/Suggestions.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/Settings.svelte', content: '', type: 'component' },
	...
	admin: {
		...
		files: [
			...
			{ path: 'shared/admin/context.ts', content: '', type: 'types' },
		],
		dependencies: [{ name: 'svelte', version: '^5.0.0' }],
		devDependencies: [],
	...
	messaging: {
		...
		files: [
			...
			{ path: 'shared/messaging/context.ts', content: '', type: 'types' },
		],
		dependencies: [{ name: 'svelte', version: '^5.0.0' }],
		devDependencies: [],
		registryDependencies: ['button'],
