...
export const sharedModuleRegistry: Record<string, SharedModuleMetadata> = {
	...
	notifications: {
		...
		files: [
			...
			{
				path: 'shared/notifications/WorkflowNotificationItem.svelte',
				content: '',
				type: 'component',
			},
	...
	agent: {
		name: 'agent',
		type: 'shared',
		description: 'Agent workflow surfaces, lifecycle naming, and Stitch anchor metadata',
		packageName: '@equaltoai/greater-components',
		...
		files: [
			{ path: 'shared/agent/AgentIdentityCard.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/AgentStateBadge.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/SoulRequestCard.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/SoulLifecycleRail.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/ReviewDecisionCard.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/DeclarationPreviewCard.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/SignatureCheckpointCard.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/ContinuityPanel.svelte', content: '', type: 'component' },
			{ path: 'shared/agent/GraduationSummaryCard.svelte', content: '', type: 'component' },
			...
			{ path: 'shared/agent/surfaces.ts', content: '', type: 'types' },
		],
		dependencies: [{ name: 'svelte', version: '^5.0.0' }],
		devDependencies: [],
		registryDependencies: [],
		tags: ['agent', 'workflow', 'surfaces', 'stitch', 'shared'],
		version: '1.0.0',
		domain: 'agent',
	},
	...
	chat: {
		...
		packageName: '@equaltoai/greater-components',
		exportPath: '@equaltoai/greater-components/shared/chat',
		exports: [
			'Container',
			'Messages',
			'Message',
		...
		files: [
			...
			{ path: 'shared/chat/ChatWorkflowMoment.svelte', content: '', type: 'component' },
			{ path: 'shared/chat/ChatWorkflowMetadata.svelte', content: '', type: 'component' },
	...
	admin: {
		...
		files: [
			...
			{ path: 'shared/admin/Agents/AgentBadge.svelte', content: '', type: 'component' },
			{ path: 'shared/admin/Agents/AgentDirectory.svelte', content: '', type: 'component' },
			{ path: 'shared/admin/Agents/AgentAttribution.svelte', content: '', type: 'component' },
			{ path: 'shared/admin/Agents/index.ts', content: '', type: 'component' },
			{ path: 'shared/admin/Agents/types.ts', content: '', type: 'types' },
	...
	messaging: {
		...
		files: [
			...
			{ path: 'shared/messaging/WorkflowThreadMoment.svelte', content: '', type: 'component' },
			{
				path: 'shared/messaging/ConversationWorkflowSummary.svelte',
				content: '',
				type: 'component',
			},
