 ...
 */
export declare function relativeTime(date: Date | string | number, options?: RelativeTimeOptions): string;
/**
 ...
 */
export declare function formatDateTime(date: Date | string | number, options?: RelativeTimeOptions & {
 ...
 */
export declare function getDuration(start: Date | string | number, end: Date | string | number, options?: {
    locale?: string;
    units?: number;
}): string;
