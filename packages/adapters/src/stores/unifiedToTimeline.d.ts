 ...
 */
export declare function unifiedStatusToTimelineItem(status: UnifiedStatus): Omit<TimelineItem, 'id' | 'timestamp'>;
/**
 * Batch convert multiple UnifiedStatus objects to TimelineItems
 */
export declare function unifiedStatusesToTimelineItems(statuses: UnifiedStatus[]): Array<Omit<TimelineItem, 'id' | 'timestamp'>>;
