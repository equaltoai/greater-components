...
describe('timelineStore', () => {
    ...
    describe('Pagination', () => {
        it('should fetch page on loadMore', async () => {
            ...
            expect(fetchHelpers.fetchTimelinePage).toHaveBeenCalledWith(expect.objectContaining({
                after: 'cursor-1'
            }));
    ...
    describe('CRUD Operations', () => {
        it('should add item optimistically', () => {
            ...
            store.addItem({ content: { id: 'new', createdAt: new Date().toISOString() }, type: 'status' });
