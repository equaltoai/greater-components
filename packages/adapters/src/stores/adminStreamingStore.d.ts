...
export interface PerformanceAlert {
    id: string;
    service: 'GRAPHQL_API' | 'FEDERATION_DELIVERY' | 'MEDIA_PROCESSOR' | 'MODERATION_ENGINE' | 'SEARCH_INDEXER' | 'STREAMING_SERVICE';
    metric: string;
    threshold: number;
    actualValue: number;
...
export declare class AdminStreamingStore {
     ...
     */
    getModerationQueueByPriority(priority: 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL'): ModerationQueueItem[];
    /**
 ...
 */
export declare function createAdminStreamingStore(config?: AdminStreamingStoreConfig): AdminStreamingStore;
export {};
