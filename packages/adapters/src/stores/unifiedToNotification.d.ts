 ...
 */
export declare function unifiedNotificationToStoreNotification(notification: UnifiedNotification): Omit<StoreNotification, 'id' | 'timestamp'>;
/**
 * Batch convert multiple UnifiedNotifications
 */
export declare function unifiedNotificationsToStoreNotifications(notifications: UnifiedNotification[]): Array<Omit<StoreNotification, 'id' | 'timestamp'>>;
