...
import type { UnifiedAccount, UnifiedStatus, UnifiedNotification, StreamingUpdate, StreamingDelete, StreamingEdit } from '../models/unified.js';
...
export declare class TimelineStreamingHandler implements StreamingOperationHandler {
    ...
    type: string;
    constructor(onStatusUpdate: (status: UnifiedStatus) => void, onStatusDelete: (statusId: string) => void, onStatusEdit: (status: UnifiedStatus) => void);
    handle(operation: StreamingOperation): Promise<void>;
}
/**
...
export declare class NotificationStreamingHandler implements StreamingOperationHandler {
    ...
    type: string;
    constructor(onNotificationUpdate: (notification: UnifiedNotification) => void, onNotificationDelete: (notificationId: string) => void);
    handle(operation: StreamingOperation): Promise<void>;
}
/**
...
export declare class AccountStreamingHandler implements StreamingOperationHandler {
    ...
    type: string;
    constructor(onAccountUpdate: (account: UnifiedAccount) => void, onAccountDelete: (accountId: string) => void);
    handle(operation: StreamingOperation): Promise<void>;
}
/**
