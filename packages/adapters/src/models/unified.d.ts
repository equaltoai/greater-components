...
export interface StreamingUpdate {
    /** Update type */
    type: 'status' | 'delete' | 'notification' | 'filters_changed' | 'conversation' | 'announcement' | 'timelineUpdates' | 'notificationStream' | 'conversationUpdates' | 'listUpdates' | 'activityStream' | 'relationshipUpdates' | 'quoteActivity' | 'hashtagActivity' | 'trustUpdates' | 'moderationEvents' | 'moderationAlerts' | 'moderationQueueUpdate' | 'threatIntelligence' | 'aiAnalysisUpdates' | 'costUpdates' | 'costAlerts' | 'budgetAlerts' | 'metricsUpdates' | 'performanceAlert' | 'federationHealthUpdates' | 'infrastructureEvent';
    /** Event data */
    payload: unknown;
