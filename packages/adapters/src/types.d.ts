import type { TimelineUpdatesSubscription, NotificationStreamSubscription, QuoteActivitySubscription, HashtagActivitySubscription, ListUpdatesSubscription, RelationshipUpdatesSubscription, TrustUpdatesSubscription, ModerationEventsSubscription, ModerationAlertsSubscription, ModerationQueueUpdateSubscription, CostAlertsSubscription } from './graphql/generated/types.js';
/**
...
export type WebSocketEventType = 'open' | 'close' | 'error' | 'message' | 'reconnecting' | 'reconnected' | 'latency';
...
export type TransportFallbackState = (SseClientState & {
    transport: 'sse';
