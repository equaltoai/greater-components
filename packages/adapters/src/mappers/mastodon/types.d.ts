...
export declare const MASTODON_VISIBILITY_VALUES: readonly ["public", "unlisted", "private", "direct"];
export declare const MASTODON_MEDIA_TYPES: readonly ["image", "video", "gifv", "audio", "unknown"];
export declare const MASTODON_NOTIFICATION_TYPES: readonly ["mention", "status", "reblog", "follow", "follow_request", "favourite", "poll", "update", "admin.sign_up", "admin.report"];
