...
export function convertGraphQLObjectToLesser(
	...
	return {
		...
		boosted: toBoolean(object['boosted']),
		viewerFavourited: toBoolean(object['viewerFavourited']),
		viewerBookmarked: toBoolean(object['viewerBookmarked']),
		viewerPinned: toBoolean(object['viewerPinned']),
