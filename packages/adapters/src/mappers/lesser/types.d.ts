...
export type LesserStreamingData = LesserPostStreamingData | LesserNotificationStreamingData | LesserAccountStreamingData | LesserDeleteStreamingData;
...
export declare function isLesserNotificationFragment(obj: unknown): obj is LesserNotificationFragment;
...
export declare const LESSER_VISIBILITY_VALUES: readonly ["PUBLIC", "UNLISTED", "FOLLOWERS", "DIRECT"];
export declare const LESSER_MEDIA_TYPES: readonly ["IMAGE", "VIDEO", "AUDIO", "GIF", "UNKNOWN"];
export declare const LESSER_NOTIFICATION_TYPES: readonly ["MENTION", "FOLLOW", "FOLLOW_REQUEST", "SHARE", "FAVORITE", "POST", "POLL_ENDED", "STATUS_UPDATE", "ADMIN_SIGNUP", "ADMIN_REPORT"];
