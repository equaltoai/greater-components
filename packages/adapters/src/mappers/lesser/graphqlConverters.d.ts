...
export declare function convertGraphQLActorToLesserAccount(actor: unknown): LesserAccountFragment | null;
export declare function convertGraphQLObjectToLesser(object: unknown, depth?: number): LesserObjectFragment | null;
