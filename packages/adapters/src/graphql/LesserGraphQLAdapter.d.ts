...
import type { TimelineQueryVariables, TimelineType, NotificationsQueryVariables, SearchQueryVariables, CreateNoteMutationVariables, CreateQuoteNoteMutationVariables, CreateListMutationVariables, UpdateListMutationVariables, ConversationsQueryVariables, UpdateRelationshipMutationVariables, TimelineUpdatesSubscription, TimelineUpdatesSubscriptionVariables, NotificationStreamSubscription, NotificationStreamSubscriptionVariables, ConversationUpdatesSubscription, ListUpdatesSubscription, ListUpdatesSubscriptionVariables, QuoteActivitySubscription, QuoteActivitySubscriptionVariables, HashtagActivitySubscription, HashtagActivitySubscriptionVariables, ActivityStreamSubscription, ActivityStreamSubscriptionVariables, RelationshipUpdatesSubscription, RelationshipUpdatesSubscriptionVariables, CostUpdatesSubscription, CostUpdatesSubscriptionVariables, ModerationEventsSubscription, ModerationEventsSubscriptionVariables, TrustUpdatesSubscription, TrustUpdatesSubscriptionVariables, AiAnalysisUpdatesSubscription, AiAnalysisUpdatesSubscriptionVariables, MetricsUpdatesSubscription, MetricsUpdatesSubscriptionVariables, ModerationAlertsSubscription, ModerationAlertsSubscriptionVariables, CostAlertsSubscription, CostAlertsSubscriptionVariables, BudgetAlertsSubscription, BudgetAlertsSubscriptionVariables, FederationHealthUpdatesSubscription, FederationHealthUpdatesSubscriptionVariables, ModerationQueueUpdateSubscription, ModerationQueueUpdateSubscriptionVariables, ThreatIntelligenceSubscription, PerformanceAlertSubscription, PerformanceAlertSubscriptionVariables, InfrastructureEventSubscription, RelationshipQuery, ModerationPatternInput, HashtagNotificationSettingsInput, NotificationLevel, UploadMediaInput, UploadMediaMutation } from './generated/types.js';
...
export declare class LesserGraphQLAdapter {
    ...
    fetchHomeTimeline(pagination?: Partial<Pick<TimelineQueryVariables, 'first' | 'after'>>): Promise<{
        readonly __typename: "ObjectConnection";
        readonly totalCount: number;
        readonly edges: ReadonlyArray<{
            readonly __typename: "ObjectEdge";
    ...
    fetchPublicTimeline(pagination?: Partial<Pick<TimelineQueryVariables, 'first' | 'after'>>, scope?: Extract<TimelineType, 'PUBLIC' | 'LOCAL'>): Promise<{
        readonly __typename: "ObjectConnection";
        readonly totalCount: number;
        readonly edges: ReadonlyArray<{
            readonly __typename: "ObjectEdge";
    ...
    fetchDirectTimeline(pagination?: Partial<Pick<TimelineQueryVariables, 'first' | 'after'>>): Promise<{
        readonly __typename: "ObjectConnection";
        readonly totalCount: number;
        readonly edges: ReadonlyArray<{
            readonly __typename: "ObjectEdge";
    ...
    fetchHashtagTimeline(hashtag: string, pagination?: Partial<Pick<TimelineQueryVariables, 'first' | 'after'>>): Promise<{
        readonly __typename: "ObjectConnection";
        readonly totalCount: number;
        readonly edges: ReadonlyArray<{
            readonly __typename: "ObjectEdge";
    ...
    fetchListTimeline(listId: string, pagination?: Partial<Pick<TimelineQueryVariables, 'first' | 'after'>>): Promise<{
        readonly __typename: "ObjectConnection";
        readonly totalCount: number;
        readonly edges: ReadonlyArray<{
            readonly __typename: "ObjectEdge";
    ...
    fetchActorTimeline(actorId: string, pagination?: Partial<Pick<TimelineQueryVariables, 'first' | 'after' | 'mediaOnly'>>): Promise<{
        readonly __typename: "ObjectConnection";
        readonly totalCount: number;
        readonly edges: ReadonlyArray<{
            readonly __typename: "ObjectEdge";
    ...
    getConversations(variables: ConversationsQueryVariables): Promise<readonly {
    ...
    getListAccounts(id: string): Promise<readonly {
        readonly __typename: "Actor";
        readonly id: string;
        readonly username: string;
        readonly domain?: string | null | undefined;
    ...
    updateList(id: string, input: UpdateListMutationVariables['input']): Promise<{
        readonly __typename: "List";
        readonly id: string;
        readonly title: string;
        readonly repliesPolicy: import("./index.js").RepliesPolicy;
    ...
    addAccountsToList(id: string, accountIds: string[]): Promise<{
        readonly __typename: "List";
        readonly id: string;
        readonly accountCount: number;
        readonly accounts: ReadonlyArray<{
    ...
    removeAccountsFromList(id: string, accountIds: string[]): Promise<{
        readonly __typename: "List";
        readonly id: string;
        readonly accountCount: number;
        readonly accounts: ReadonlyArray<{
    ...
    getObjectWithQuotes(id: string, first?: number, after?: string): Promise<{
        readonly __typename: "Object";
        readonly id: string;
        readonly type: import("./index.js").ObjectType;
        readonly content: string;
    ...
    updateQuotePermissions(noteId: string, quoteable: boolean, permission: 'EVERYONE' | 'FOLLOWERS' | 'NONE'): Promise<{
    ...
    getRelationships(ids: string[]): Promise<readonly {
    ...
    muteActor(id: string, notifications?: boolean): Promise<{
        readonly __typename: "Relationship";
        readonly id: string;
        readonly following: boolean;
        readonly followedBy: boolean;
    ...
    updateRelationship(id: string, input: UpdateRelationshipMutationVariables['input']): Promise<{
        readonly __typename: "Relationship";
        readonly id: string;
        readonly following: boolean;
        readonly followedBy: boolean;
    ...
    getFollowers(username: string, limit?: number, cursor?: string): Promise<{
    ...
    getFollowing(username: string, limit?: number, cursor?: string): Promise<{
        readonly __typename: "ActorListPage";
        readonly nextCursor?: string | null | undefined;
        readonly totalCount: number;
        readonly actors: ReadonlyArray<{
    ...
    voteCommunityNote(id: string, helpful: boolean): Promise<{
        readonly __typename: "CommunityNote";
        readonly id: string;
        readonly content: string;
        readonly helpful: number;
    ...
    getCommunityNotesByObject(objectId: string, first?: number, after?: string): Promise<{
        readonly __typename: "Object";
        readonly id: string;
        readonly type: import("./index.js").ObjectType;
        readonly content: string;
    ...
    requestAIAnalysis(objectId: string, objectType?: string, force?: boolean): Promise<{
    ...
    getTrustGraph(actorId: string, category?: 'CONTENT' | 'BEHAVIOR' | 'TECHNICAL'): Promise<readonly {
    ...
    getInstanceBudgets(): Promise<readonly {
    ...
    setInstanceBudget(domain: string, monthlyUSD: number, autoLimit?: boolean): Promise<{
        readonly __typename: "InstanceBudget";
        readonly domain: string;
        readonly monthlyBudgetUSD: number;
        readonly currentSpendUSD: number;
    ...
    getFederationLimits(): Promise<readonly {
    ...
    setFederationLimit(domain: string, limit: Record<string, unknown>): Promise<{
        readonly __typename: "FederationLimit";
        readonly domain: string;
        readonly ingressLimitMB: number;
        readonly egressLimitMB: number;
    ...
    syncThread(noteUrl: string, depth?: number): Promise<{
    ...
    getSeveredRelationships(instance?: string, first?: number, after?: string): Promise<{
    ...
    getFederationHealth(threshold?: number): Promise<readonly {
    ...
    pauseFederation(domain: string, reason: string, until?: string): Promise<{
        readonly __typename: "FederationManagementStatus";
        readonly domain: string;
        readonly status: import("./index.js").FederationState;
        readonly reason?: string | null | undefined;
    ...
    followHashtag(hashtag: string, notifyLevel?: 'ALL' | 'MUTUALS' | 'FOLLOWING' | 'NONE'): Promise<{
    ...
    muteHashtag(hashtag: string, until?: string): Promise<{
    ...
    getFollowedHashtags(first?: number, after?: string): Promise<{
    ...
    updateHashtagNotifications(hashtag: string, settings: HashtagNotificationSettingsInput): Promise<{
        success: boolean;
        hashtag?: {
            name: string;
    ...
    unmuteHashtag(hashtag: string, options?: {
        level?: NotificationLevel;
        mutedUntil?: string | null;
    ...
    subscribeToTimelineUpdates(variables: TimelineUpdatesSubscriptionVariables): Observable<FetchResult<TimelineUpdatesSubscription>>;
    subscribeToNotificationStream(variables?: NotificationStreamSubscriptionVariables): Observable<FetchResult<NotificationStreamSubscription>>;
    subscribeToConversationUpdates(): Observable<FetchResult<ConversationUpdatesSubscription>>;
    subscribeToListUpdates(variables: ListUpdatesSubscriptionVariables): Observable<FetchResult<ListUpdatesSubscription>>;
    subscribeToQuoteActivity(variables: QuoteActivitySubscriptionVariables): Observable<FetchResult<QuoteActivitySubscription>>;
    subscribeToHashtagActivity(variables: HashtagActivitySubscriptionVariables): Observable<FetchResult<HashtagActivitySubscription>>;
...
export declare function createLesserGraphQLAdapter(config: LesserGraphQLAdapterConfig): LesserGraphQLAdapter;
