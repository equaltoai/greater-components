<script lang="ts">
	...
	const navigation: NavSection[] = [
		...
		},
		{
			...
			items: [
				{ title: 'SignInCard', href: '/components/signin-card', status: 'stable' },
				{ title: 'UserButton', href: '/components/user-button', status: 'stable' },
				{ title: 'LoginForm', href: '/components/login-form', status: 'stable' },
				{ title: 'RegisterForm', href: '/components/register-form', status: 'stable' },
			],
		},
		{
