<script lang="ts">
  ...
  import { Menu, Button, ThemeSwitcher, preferencesStore, type PreferencesState } from '@equaltoai/greater-components-primitives';
...
>
  <section class="demo-section">
    <header>
      ...
      <p>Primary dropdown plus a nested submenu showcase roving tabindex, typeahead, and disabled states.</p>
    </header>
    ...
    <p class="a11y-tip">Press Tab to focus the trigger, then use ArrowDown and typeahead letters to move through options.</p>
  ...
  <section class="demo-section">
    ...
    <p class="a11y-tip">Screen readers surface this as a button; Shift+F10 mirrors contextmenu for keyboard-only users.</p>
  ...
  <section class="demo-section">
    <header>
      ...
      <p>Compact switcher fits headers, while the full panel exposes density, font, and motion controls.</p>
    </header>
    ...
    <p class="a11y-tip">The switcher writes to <code>preferencesStore</code>; summarize changes nearby for users who miss visual cues.</p>
  ...
  <section class="demo-section">
    <header>
      ...
      <p>Wrap the entire playground (already done in layout) with ThemeProvider so tokens load before paint.</p>
    </header>

    <p class="a11y-tip">Keep the provider close to <code>&lt;body&gt;</code> so color variables initialize before content flashes.</p>
