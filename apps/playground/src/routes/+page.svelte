...
<div class="playground">
  ...
  <section class="hero">
    ...
    <p>
      Explore our component library with live examples, interactive controls, and comprehensive documentation.
      All components are built with Svelte 5, TypeScript, and full accessibility support.
    </p>
...
<Modal bind:open={showModal} title="Get Started with Greater Components">
  <div class="modal-content">
    <p>Welcome! Tell us a bit about yourself to get personalized updates about Greater Components.</p>
  ...
  {#snippet footer()}
    <div class="modal-actions">
      ...
      <Button onclick={handleSubmit} disabled={!name || !email || !!emailError}>
        Subscribe
      </Button>
    </div>
  {/snippet}
