...
<div class="tabs-page">
	...
	<section>
		...
		<p class="note">
			Use the arrow keys to move focus, then press Enter/Space to activate the tab.
		</p>
		<Tabs
			tabs={accountTabs}
...
{#snippet OverviewContent()}
	<div class="tab-panel">
		<h3>Overview</h3>
		<p>
			The Tabs component supports keyboard navigation, roving tabindex, and aria relationships out
			of the box.
		</p>
		<ul>
...
{#snippet FeaturesContent()}
	<div class="tab-panel">
		<h3>Features</h3>
		<p>
			Each tab accepts an arbitrary snippet so you can render any Svelte markup (forms, cards,
			etc.).
		</p>
		<div class="pill-row">
			<span>Pills</span>
